  ...
  return (
    <div className="p-4 pb-20 max-w-lg mx-auto">
      ...
      {stats && stats.recentBadEncounters > 0 && (
        <div className="alert alert-warning mt-4 flex-col items-start gap-1">
          ...
          <p className="text-xs opacity-80 ml-7">
            Flags are user-submitted and unverified. Do not confront or follow - report concerns to authorities.
          </p>
        </div>
      )}
