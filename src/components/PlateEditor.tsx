        ...
        <div className="form-control">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`btn flex-1 ${experience === 'good' ? 'btn-success' : 'btn-outline'}`}
            >
            ...
            <button
              ...
              className={`btn flex-1 ${experience === 'neutral' ? 'btn-info' : 'btn-outline'}`}
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
            ...
            <button
              ...
              className={`btn flex-1 ${experience === 'bad' ? 'btn-error' : 'btn-outline'}`}
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
